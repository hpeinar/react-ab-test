...
var _calculateActiveVariant = _interopRequireDefault(
  require('./calculateActiveVariant')
);
...
PushtellEventEmitter.prototype.addActiveVariantListener = function (
  ...
  if (typeof experimentName === 'function') {
    ...
    return emitter.addListener(
      'active-variant',
      function (_experimentName, variantName, passthrough) {
...
PushtellEventEmitter.prototype.calculateActiveVariant = function (
  ...
  var variant = (0, _calculateActiveVariant['default'])(
    experimentName,
    userIdentifier,
    defaultVariantName
  );
